...
namespace Pms.Api.Controllers
{
    ...
    {
        private readonly IUserPerformanceReviewService _userPerformanceReviewService;

        public UserPerformanceReviewController(IUserPerformanceReviewService userPerformanceReviewService)
        {
        ...
        public async Task<IActionResult> GetUserPerformanceReviewsAsync([FromQuery] UserPerformanceReviewQueryFilter filter)
